...
if is_torch_available():
    ...
    _import_structure["autoencoders.autoencoder_kl_VicTrWan"] = ["AutoencoderKLVicTrWan"]
    ...
    _import_structure["transformers.transformer_VicTrWan"] = ["VicTrWanTransformer3DModel"]
    _import_structure["transformers.transformer_VicTrWan_vace"] = ["VicTrWanVACETransformer3DModel"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    if is_torch_available():
        ...
        from .transformers import (
            ...
            VicTrWanTransformer3DModel,
            VicTrWanVACETransformer3DModel,
        )
        from .unets import (
            I2VGenXLUNet,
            Kandinsky3UNet,
